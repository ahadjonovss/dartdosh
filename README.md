...
| Question | |
|----------|--|
| How do I set up dartdosh in my project? | [GitHub →](https://github.com/ahadjonovss/dartdosh/blob/main/doc/en/01-getting-started.md) |
| How do I configure build commands? | [GitHub →](https://github.com/ahadjonovss/dartdosh/blob/main/doc/en/02-configuration.md) |
| What build commands and flags are available? | [GitHub →](https://github.com/ahadjonovss/dartdosh/blob/main/doc/en/03-build-commands.md) |
| How does auto version increment and file naming work? | [GitHub →](https://github.com/ahadjonovss/dartdosh/blob/main/doc/en/04-version-management.md) |
